...
# Load data
loans_df <- read_rds("C:/Users/cjent/OneDrive/Desktop/Classes/Spring 2022/MIS 431/Final Project/loan_data.rds")
...
#ROC Curve
roc_curve(logistic_results, truth = loan_default, estimate = .pred_yes) %>% autoplot()
...
knn_predictions %>% roc_curve(truth = loan_default, estimate = .pred_yes) %>%
  autoplot()
